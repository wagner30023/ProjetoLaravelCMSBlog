        ...
        <div class="card-body">
            <form action="{{ route('settings.save')}}" method="POST" class="form-horizontal" >
                ...
                <div class="form-group row">
                    <label class="col-sm-2 control-label"> Título do site </label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 control-label"> titulo do site </label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 control-label"> E-mail para contato </label>
                    <div class="col-sm-10">
